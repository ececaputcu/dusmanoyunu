...
if __name__ == '__main__':
    ...
    class rekabet():
        ...
        def print(self):
            ...
            print(self.isim + ",",
                  "Can: {} Saldırı gücü: {} Mermi sayısı: {}".format(self.can, self.guc, self.kalan_mermi))
    ...
    while (True):
        if (len(dusmanlar) == 5):
            dusman1 = random.randint(0,
                                     4)  # 0 ve 4 dahil. random.randrange(0,4) yapsaydık 0 dahil olacak ama 4 olmayacaktı.
            ...
            if (dusman2 == dusman1) or ((dusman2 > dusman1) and (dusman2 == 3)):
                ...
                print("\n\n")
                donen_deger = dusmanlar[dusman1].saldir()
                dusmanlar[dusman2].vuruldu(donen_deger[0], donen_deger[1])
